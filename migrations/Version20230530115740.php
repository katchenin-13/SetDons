 ...
 */
final class Version20230530115740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rapportmission ADD vv VARCHAR(255) NOT NULL, ADD dateretour DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rapportmission DROP vv, DROP dateretour');
    }
}
