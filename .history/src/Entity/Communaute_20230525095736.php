...
class Communaute
{
    ...
    #[Assert\NotBlank(message: 'Veuillez renseigner le libnoéllé')]
    #[Assert\Length(
        min: 4,
        max: 100,
        minMessage: "Le no doit faire au moins {{ limit }} caractères",
        maxMessage: "Le no ne doit pas faire plus de {{ limit }} caractères"
    )]
