...
class Rapportmission
{
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "les opportunites doient faire au moins {{ limit }} caractères",
        maxMessage: "les opportunites ne doient pas faire plus de {{ limit }} caractères"
    )]
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "Les difficulté doient faire au moins {{ limit }} caractères",
        maxMessage: "Les difficulté ne doient pas faire plus de {{ limit }} caractères"
    )]
