...
class Rapportmission
{
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "les opportunites doiv faire au moins {{ limit }} caractères",
        maxMessage: "les opportunites ne doiv pas faire plus de {{ limit }} caractères"
    )]
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "Les difficulté doiv faire au moins {{ limit }} caractères",
        maxMessage: "Les difficulté ne doiv pas faire plus de {{ limit }} caractères"
    )]
