...
class Rapportmission
{
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "les opportunites d faire au moins {{ limit }} caractères",
        maxMessage: "les opportunites ne d pas faire plus de {{ limit }} caractères"
    )]
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "Les difficulté d faire au moins {{ limit }} caractères",
        maxMessage: "Les difficulté ne d pas faire plus de {{ limit }} caractères"
    )]
