...
class Rapportmission
{
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "les opportunites doie faire au moins {{ limit }} caractères",
        maxMessage: "les opportunites ne doie pas faire plus de {{ limit }} caractères"
    )]
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "Les difficulté doie faire au moins {{ limit }} caractères",
        maxMessage: "Les difficulté ne doie pas faire plus de {{ limit }} caractères"
    )]
