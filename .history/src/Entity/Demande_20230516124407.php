...
class Demande
{
    ...
    public function isStatusdeman(): ?bool
    {
        return $this->statusdeman;
    }

    public function setStatusdeman(bool $statusdeman): self
    {
        $this->statusdeman = $statusdeman;
