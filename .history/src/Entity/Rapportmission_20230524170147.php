...
class Rapportmission
{
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "les opportunites doit faire au moins {{ limit }} caractères",
        maxMessage: "les opportunites ne doit pas faire plus de {{ limit }} caractères"
    )]
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "Les difficulté doit faire au moins {{ limit }} caractères",
        maxMessage: "Les difficulté ne doit pas faire plus de {{ limit }} caractères"
    )]
