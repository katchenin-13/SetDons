...
class Categorie
{
    ...
    #[Assert\NotBlank(message: 'Veuillez renseigner le libéll')]
    #[Assert\Length(
        min: 4,
        max: 100,
        minMessage: "Le libéllé doit faire au moins {{ limit }} caractères",
        maxMessage: "Le libéllé ne doit pas faire plus de {{ limit }} caractères"
    )]
