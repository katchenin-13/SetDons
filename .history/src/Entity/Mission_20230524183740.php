...
class Mission
{
    ...
    #[Assert\GreaterThanOrEqual(#[Assert\GreaterThanOrEqual(value: "today", message: "la date de debut doit être superirieure ou égale a aujourd'hui")], message: "la date de debut doit être superirieure ou égale a aujourd'hui")]
