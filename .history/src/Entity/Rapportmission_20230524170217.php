...
class Rapportmission
{
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "les opportunites doi faire au moins {{ limit }} caractères",
        maxMessage: "les opportunites ne doi pas faire plus de {{ limit }} caractères"
    )]
    ...
    #[Assert\Length(
        min: 10,
        max: 300,
        minMessage: "Les difficulté doi faire au moins {{ limit }} caractères",
        maxMessage: "Les difficulté ne doi pas faire plus de {{ limit }} caractères"
    )]
