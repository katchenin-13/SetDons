...
{   /**
    ...
    */
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory): Response
    {
        ...
        if ($hasActions) {
            $table->add('id', TextColumn::class, [
                ...
                , 'render' => function ($value, Categorie $context) use ($renders) {
                    $options = [
        ...
        return $this->render('parametre/categorie/index.html.twig', [
            'datatable' => $table
        ]);
    }

     /**
      * cette fonction permettte de generer un pdf de catégorie
      *
      * @param CategorieRepository $categorie
      * @return Response
      */
    #[Route('/pdf/generator/categorie', name: 'app_pdf_generator_categorie')]
    public function generatePdf(CategorieRepository $categorie): Response
    {
        $data = $categorie->findAll();
        $html =  $this->renderView('parametre/categorie/detail.html.twig', [
            'data' => $data
        ]);
        $dompdf = new Dompdf();
    ...
    public function new(Request $request, CategorieRepository $categorieRepository, FormError $formError): Response
    {
        ...
        if ($form->isSubmitted()) {
            $response = [];
            $redirect = $this->generateUrl('app_parametre_categorie_index');
        ...
        return $this->renderForm('parametre/categorie/new.html.twig', [
            'categorie' => $categorie,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Categorie $categorie, CategorieRepository $categorieRepository, FormError $formError): Response
    {
        ...
        return $this->renderForm('parametre/categorie/edit.html.twig', [
            'categorie' => $categorie,
            'form' => $form,
        ]);
    }

    #[Route('/{id}/delete', name: 'app_parametre_categorie_delete', methods: ['DELETE', 'GET'])]
    public function delete(Request $request, Categorie $categorie, CategorieRepository $categorieRepository): Response
    {
        $form = $this->createFormBuilder()
            ->setAction(
                $this->generateUrl(
                'app_parametre_categorie_delete'
                ,   [
                        'id' => $categorie->getId()
                    ]
                )
        ...
        return $this->renderForm('parametre/categorie/delete.html.twig', [
            'categorie' => $categorie,
            'form' => $form,
        ]);
    }
