    ...
    public function index(Request $request, Breadcrumb $breadcrumb): Response
    {
        $modules = [
            [
                ...
                'icon' => 'bi bi-people',
                'href' => $this->generateUrl('app_gestion_mission_index', ['module' => 'Gestion des dons'])
            ],
            
            [
                'label' => 'Liste des promesses',
                'icon' => 'bi bi-people',
                'href' => $this->generateUrl('app_gestion_rapportmission_index', ['module' => 'Gestion des rapport mid'])
            ],
