...
class StatistiqueController extends AbstractController
{
        ...
        $parametres = [
            ...
            'graphiques' => [
                [
                    ...
                    'id' => 'chart_statut',
                    'icon' => 'bi bi-list',
                    'href' => $this->generateUrl('app_con_statut')
                ],
                [
                    'label' => 'Effectifs par sexe',
                    'id' => 'chart_genre',
                    'icon' => 'bi bi-list',
                    'href' => $this->generateUrl('app_con_genre')
                ],
                [
                    'label' => 'Effectifs par niveau hierarchique et Sexe',
                    'id' => 'chart_h_sexe',
                    'icon' => 'bi bi-list',
                    'href' => $this->generateUrl('app_con_hierarchie_sexe')
                ],
                [
                    'label' => 'Evolution des effectifs par type de contrat',
                    'id' => 'chart_contrat',
                    'icon' => 'bi bi-list',
                    'href' => $this->generateUrl('app_con_type_contrat')
                ],
                [
                    'label' => 'Pyramide des âges',
                    'id' => 'chart_py_age',
                    'icon' => 'bi bi-list',
                    'href' => $this->generateUrl('app_con_pyramide_age')
                ],
                [
                    'label' => 'Pyramide des anciennetés',
                    'id' => 'chart_py_anc',
                    'icon' => 'bi bi-list',
                    'href' => $this->generateUrl('app_con_pyramide_anc')
                ],
                [
                    'label' => 'Effectifs par sexe et par niveau de maîtrise',
                    'id' => 'chart_maitrise',
                    'icon' => 'bi bi-list',
                    'href' => $this->generateUrl('app_con_maitrise_sexe')
                ]
    ...
    #[Route('/statut', name: 'app_con_statut')]
    ...
    #[Route('/data-statut', name: 'app_con_statut_data')]
    ...
    #[Route('/genre', name: 'app_con_genre')]
    ...
    #[Route('/data-genre', name: 'app_con_genre_data')]
    ...
    #[Route('/hierarchie-sexe', name: 'app_con_hierarchie_sexe')]
    ...
    #[Route('/data-hierarchie-sexe', name: 'app_con_hierarchie_sexe_data')]
    ...
    #[Route('/maitrise-sexe', name: 'app_con_maitrise_sexe')]
    ...
    #[Route('/data-maitrise-sexe', name: 'app_con_maitrise_sexe_data')]
    ...
    #[Route('/pyramide-age', name: 'app_con_pyramide_age')]
    ...
    #[Route('/pyramide-age-data', name: 'app_con_pyramide_age_data')]
    ...
    #[Route('/pyramide-anc', name: 'app_con_pyramide_anc')]
    ...
    #[Route('/pyramide-anc-data', name: 'app_con_pyramide_anc_data')]
    ...
    #[Route('/data-type-contrat', name: 'app_con_type_contrat_data', condition: "request.query.has('filters')")]
    ...
    #[Route('/type-contrat', name: 'app_con_type_contrat')]
    public function indexTypeContrat()
    {
        $formBuilder = $this->createFormBuilder()
            ->setAction($this->generateUrl('app_con_type_contrat'))
            ->setMethod('POST');
