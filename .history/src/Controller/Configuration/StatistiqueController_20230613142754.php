...
class StatistiqueController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'app_config_stat_index', methods: ['GET', 'POST'])]
    public function index(Request $request, Breadcrumb $breadcrumb): Response
    {
        $modules = [
            [
                'label' => 'Général',
                'icon' => 'bi bi-list',
                'href' => $this->generateUrl('app_config_stat_ls', ['module' => 'config'])
            ],
            [
                'label' => 'Ressource humaine',
                'icon' => 'bi bi-truck',
                'href' => $this->generateUrl('app_config_stat_ls', ['module' => 'rh'])
            ],
            [
                'label' => 'Gestion des accès',
                'icon' => 'bi bi-users',
                'href' => $this->generateUrl('app_config_stat_ls', ['module' => 'utilisateur'])
            ],
