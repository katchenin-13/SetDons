...
class StatistiqueController extends AbstractController
{
    ...
    private function createFilterForm()
    {
        ...
        $formBuilder = $this->createFormBuilder()
            ->setAction($this->generateUrl('app_rh_dashboard_index'))
            ->setMethod('POST');
        ...
        $formBuilder->add('mois', ChoiceType::class, ['choices' => array_flip(::MOIS), 'label' => 'Mois', 'attr' => ['class' => 'has-select2']]);
    ...
    public function indexTypeContrat(Request $request, EmployeRepository $employeRepository, GenreRepository $genreRepository, NiveauHierarchiqueRepository $niveauHierarchiqueRepository)
    {
        ...
        return $this->renderForm('rh/dashboard/type_contrat.html.twig', [
            'form' => $form
        ]);
    }
