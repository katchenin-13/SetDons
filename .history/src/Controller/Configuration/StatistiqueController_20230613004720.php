...
class StatistiqueController extends AbstractController
{
    ...
    public function dataTypeContrat(Request $request, EmployeRepository $employeRepository, CommunauteRepository $typeContratRepository)
    {
        ...
        $typeContrat = $audiencee->find($typeContratId);
