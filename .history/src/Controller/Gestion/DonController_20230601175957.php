...
class DonController extends AbstractController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory,StatsService $service,FieldonRepository $fieldonRepository,Fieldon $fieldon): Response
    {  
        $id = $service->Countfieldon();
     
    
        for ($i=0; $i <= $id ; $i++) {
            $fieldon = $fieldonRepository->findBy(['typedon' => $i]);
