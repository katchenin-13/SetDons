...
class AdminDashboadController extends AbstractController
 {
    ...
    public $audienceannee =[];
    public $audiencesmoiscom =[];
    public $audiencesanncom =[];
    public $audiencesmoisloca =[];
    public $audienceanneloca =[];
    public $audiencemoiscateg =[];
    public $mois = [];
     public $y = [];
    ...
    public function accueil(Request $request)
    {
       ...
       $this->audiencesmoiscom =  $this->statsService->getAudienceMoisCom(1);
