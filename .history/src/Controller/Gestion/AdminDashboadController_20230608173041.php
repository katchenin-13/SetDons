...
class AdminDashboadController extends AbstractController
 {
    ...
    private $request;
     ...
     pri $audienceannee =  $this->statsService->getAudienceAnnee();
       pri $audiencesmoiscom =  $this->statsService->getAudienceMoisCom($id);
       pri $audiencesanncom =  $this->statsService->getAudienceAnCom($id);
       pri $audiencesmoisloca =  $this->statsService->getAudienceMoisLocalie($id);
       pri $audienceanneloca = $this->statsService->getAudienceAnlocalie($id);
       pri $audiencemoiscateg;
