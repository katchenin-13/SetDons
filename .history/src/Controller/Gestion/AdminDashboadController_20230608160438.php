...
class AdminDashboadController extends AbstractController
 {
    ...
    /**
     * cette function est un api qui permet de manupuler les changer de rapport de mission
     ...
     * @return void
     */
    public function accueil(Security $security, Request $request, Audience $mission)
    {
