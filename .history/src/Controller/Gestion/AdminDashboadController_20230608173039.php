...
class AdminDashboadController extends AbstractController
 {
    ...
    private $request;
     ...
     p $audienceannee =  $this->statsService->getAudienceAnnee();
       p $audiencesmoiscom =  $this->statsService->getAudienceMoisCom($id);
       p $audiencesanncom =  $this->statsService->getAudienceAnCom($id);
       p $audiencesmoisloca =  $this->statsService->getAudienceMoisLocalie($id);
       p $audienceanneloca = $this->statsService->getAudienceAnlocalie($id);
       p $audiencemoiscateg;
