...
class DonController extends AbstractController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory ): Response
    {
        ...
        $table = $dataTableFactory->create()
           ...
           ->add('nom', TextColumn::class, ['label' => 'Beneficiaire','field' => 'nom'])
           ->add('numero', TextColumn::class, ['label' => 'Tel du béneficiare','field'=>'numero'])
            ->add('communaute', TextColumn::class, ['label' => 'Communauté','field' => 'communaute'])
