...
class RapportmissionController extends AbstractController
{
    /**
     * 
     * @Route("/api/{id}/choix", name="accueil",methods={"GET"})
     */
    public function accueil(Security $security, Request $request,MissionRepository $missionRepository Mission $mission)
    {
        $missions = $mission->getd
        ...
        //             $datefin = $missionRepository->getDateretour($id);
        ...
        //             $data = json_encode($datefin); // formater le résultat de la requête en json
        ...
        //     return new Response('Aucune donnée n\'est selectionée');
        // }
            
        }
       
      
        return $this->render('gestion/mission/new.html.twig');
    }
