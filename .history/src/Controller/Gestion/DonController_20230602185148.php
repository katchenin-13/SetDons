...
class DonController extends AbstractController
{
    ...
    public function show(Don $don,StatsService $statsService,TypedonRepository $typedonRepository): Response
    {    
        // $id = $typedonRepository->count(Typedon::class);
        // $ids = [];
        // for ($i=0; $i <$id ; $i++) { 
        //     $ids = $statsService->getfieldon($don, $id);
        // }
        return $this->render('gestion/don/show.html.twig', [
            'don' => $don,
            'espece' => $statsService->getfieldon($don, $id),
