...
class AdminDashboadController extends AbstractController
 {
    ...
    public function accueil()
    {
       ...
       $audienceannee = $statsService->getAudienceAnnee();
        $audiencesmoiscom = $statsService->getAudienceMoisCom($id);
        $audiencesanncom = $statsService ->getAudienceAnCom($id);
        $audiencesmoisloca = $statsService->g  etAudienceMoisLocalie($id);
