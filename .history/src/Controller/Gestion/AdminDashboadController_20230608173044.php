...
class AdminDashboadController extends AbstractController
 {
    ...
    private $request;
     ...
     private $audienceannee =  $this->statsService->getAudienceAnnee();
       private $audiencesmoiscom =  $this->statsService->getAudienceMoisCom($id);
       private $audiencesanncom =  $this->statsService->getAudienceAnCom($id);
       private $audiencesmoisloca =  $this->statsService->getAudienceMoisLocalie($id);
       private $audienceanneloca = $this->statsService->getAudienceAnlocalie($id);
