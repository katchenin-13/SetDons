...
class AdminDashboadController extends AbstractController
 {
    ...
    public function accueil(Security $security, Request $request):Response
    {
       ...
       c $this->audiencesmoiscom = $this->statsService->getAudienceMoisCom($this->id);
        dd();
        //dd($this->id);
    ...
    #[Route('/gestion/admin/dashboad/', name: 'app_gestion_admin_dashboad',methods: ['GET', 'POST'])]
    public function index() :Response
    {
       ...
       $audiencemois = $this->statsService->getAudienceMois();
        ...
        foreach ($this->statsService->getAudienceMoisCom(3) as $cam) {
