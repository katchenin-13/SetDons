...
class AdminDashboadController extends AbstractController
 {
    ...
    private $request;
     ...
     private $audienceannee;e->getAudienceAnnee();
       private $audiencesmoiscom;e->getAudienceMoisCom($id);
       private $audiencesanncom;e->getAudienceAnCom($id);
       private $audiencesmoisloca;e->getAudienceMoisLocalie($id);
    ...
    public function accueil()
    {
        ...
        $id =$this->id;
       $audienceannee;e->getAudienceAnnee();
        $audiencesmoiscom;e->getAudienceMoisCom($id);
