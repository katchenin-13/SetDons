...
class AdminDashboadController extends AbstractController
 {
    ...
    private $request;
     ...
     private $audienceannee ;getAudienceAnnee();
       private $audiencesmoiscom ;getAudienceMoisCom($id);
       private $audiencesanncom ;getAudienceAnCom($id);
       private $audiencesmoisloca ;getAudienceMoisLocalie($id);
       private $audienceanneloca;getAudienceAnlocalie($id);
