...
class AudienceController extends AbstractController
{
     ...
     * @param $id
     * @ParamConverter("id", class="Audience", options={"id": "id"})
     * @param Acte $parents
     * @param EntityManagerInterface $entityManager
     * @return Response
     */
    public function active(Audience $parents, EntityManagerInterface $entityManager): Response
    {

        //  dd($parents);
        if ($parents->isStatusaudience() == true) {

             $parents->setStatusaudience(false);

        } else {

            $parents->setStatusaudience(true);


         }
        // if ($parents->isMentions() == true) {

        //     $parents->setMentions(false);
        // } else {

        //     $parents->setMentions(true);
        // }
        ...
        return $this->json([
            ...
            'active' => $parents->isStatusaudience(),
            // 'mention' =>$parents->isMentions(),
       ],200);
                    ...
                    $options = [
                        ...
                        'actions' => [
                            ...
                            'statusaudience_debloquer' => [
                                ...
                                , 'attrs' => ['class' => 'btn-main active test']
                                , 'render' => new ActionRender(function () use ($context) {
                                    return !$context->isStatusaudience();
                                })
                            ],
