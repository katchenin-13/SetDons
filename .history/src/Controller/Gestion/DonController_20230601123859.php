...
class DonController extends AbstractController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory,FieldonRepository $fieldonRepository): Response
    {  $id = $fieldonRepository->getTtype
        $field = $fieldonRepository->findBy(array('soro'=>'typedon'));
        dd($field);
