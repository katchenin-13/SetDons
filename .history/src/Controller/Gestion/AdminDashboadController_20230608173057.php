...
class AdminDashboadController extends AbstractController
 {
    ...
    private $request;
     ...
     private $audienceanneee->getAudienceAnnee();
       private $audiencesmoiscome->getAudienceMoisCom($id);
       private $audiencesanncome->getAudienceAnCom($id);
       private $audiencesmoislocae->getAudienceMoisLocalie($id);
    ...
    public function accueil()
    {
        ...
        $id =$this->id;
       $audienceanneee->getAudienceAnnee();
        $audiencesmoiscome->getAudienceMoisCom($id);
