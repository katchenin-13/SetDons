...
class RapportmissionController extends AbstractController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory): Response
    {
        $table = $dataTableFactory->create()
            ...
            ->add('communaute', TextColumn::class, ['label' => 'Communauté', 'field' => 'm.libelle'])
            ...
            // ->add('difficulte')
            // ->add('prochaineetape')
            ->add('action', TextColumn::class, ['label' => 'Action réalisé sur la mission'])
            ->add('opportunite', TextColumn::class, ['label' => 'prochaineetape Mission'])
            ->add('difficulte', TextColumn::class, ['label' => 'Objectif (s) de la mission'])
            ->add('prochaineetape', TextColumn::class, ['label' => 'Objectif (s) de la mission'])
