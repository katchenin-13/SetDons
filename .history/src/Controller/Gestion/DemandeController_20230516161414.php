                    ...
                    $options = [
                        ...
                        'actions' => [
                            'statusdemande_bloquer' => [
                                'url' => $this->generateUrl('acte_', ['id' => $value]), 'ajax' => false, 'icon' => '%icon% fa  fa-unlock-alt', 'attrs' => ['class' => 'btn-main test'], 'render' => new ActionRender(function () use ($context) {
                                    return $context->isStatusdemande();
                                })
                            ],
                            'statusdemande_debloquer' => [
                                'url' => $this->generateUrl('acte_', ['id' => $value]), 'ajax' => false, 'icon' => '%icon% fa fa-lock', 'attrs' => ['class' => 'btn-danger active test'], 'render' => new ActionRender(function () use ($context) {
                                    return !$context->isStatusdemande();
                                })
                            ],
