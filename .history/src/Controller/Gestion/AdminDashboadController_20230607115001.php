...
class AdminDashboadController extends AbstractController
 {
    ...
    public function getaudience(EntityManagerInterface $mamager, StatsService $statsService, Request $request): Response
    {
        ...
        // }
        $stats = $statsService->getAudienceAnCom(2);
        dd($stats);
        // return $this->json(
    ...
    public function index(EntityManagerInterface $mamager,StatsService $statsService,Request $request,CommunauteRepository $re) :Response
    {
        ...
        $c = $request->get('debut');
       $comm = $re->findAll();
        $stats = $statsService->getAudienceMois();
        dd($stats);
