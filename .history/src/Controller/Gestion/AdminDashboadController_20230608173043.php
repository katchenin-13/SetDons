...
class AdminDashboadController extends AbstractController
 {
    ...
    private $request;
     ...
     priv $audienceannee =  $this->statsService->getAudienceAnnee();
       priv $audiencesmoiscom =  $this->statsService->getAudienceMoisCom($id);
       priv $audiencesanncom =  $this->statsService->getAudienceAnCom($id);
       priv $audiencesmoisloca =  $this->statsService->getAudienceMoisLocalie($id);
       priv $audienceanneloca = $this->statsService->getAudienceAnlocalie($id);
       priv $audiencemoiscateg;
    ...
    public function accueil()
    {
        ...
        $id =$this->id;
       $audienceannee =  $this->statsService->getAudienceAnnee();
        $audiencesmoiscom =  $this->statsService->getAudienceMoisCom($id);
        $audiencesanncom =  $this->statsService->getAudienceAnCom($id);
        $audiencesmoisloca =  $this->statsService->getAudienceMoisLocalie($id);
        $audienceanneloca = $this->statsService->getAudienceAnlocalie($id);
        $$audiencemoiscateg = $this->statsService->getAudienceMoisCetagorie($id);
