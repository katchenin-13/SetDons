...
class AdminDashboadController extends AbstractController
 {
    ...
    public function accueil()
    {
        ...
        $id =$this->id;
      thi audienceannee =  $this->statsService->getAudienceAnnee();
       thi audiencesmoiscom =  $this->statsService->getAudienceMoisCom($id);
       thi audiencesanncom =  $this->statsService->getAudienceAnCom($id);
       thi audiencesmoisloca =  $this->statsService->getAudienceMoisLocalie($id);
       thi audienceanneloca = $this->statsService->getAudienceAnlocalie($id);
       thi audiencemoiscateg = $this->statsService->getAudienceMoisCetagorie($id);
