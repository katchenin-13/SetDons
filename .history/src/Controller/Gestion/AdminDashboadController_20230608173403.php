...
class AdminDashboadController extends AbstractController
 {
    ...
    public function accueil()
    {
        ...
        $id =$this->id;
      t audienceannee =  $this->statsService->getAudienceAnnee();
       t audiencesmoiscom =  $this->statsService->getAudienceMoisCom($id);
       t audiencesanncom =  $this->statsService->getAudienceAnCom($id);
       t audiencesmoisloca =  $this->statsService->getAudienceMoisLocalie($id);
       t audienceanneloca = $this->statsService->getAudienceAnlocalie($id);
       t audiencemoiscateg = $this->statsService->getAudienceMoisCetagorie($id);
