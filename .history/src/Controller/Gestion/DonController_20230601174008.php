...
class DonController extends AbstractController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory,FieldonRepository $fieldonRepository,Fieldon $fieldon): Response
    {  
        $id = $fieldon->getTypedon();
        $field =[];
        for ($i=0; $i <$id ; $i++) {
            $fields = $fieldonRepository->findBy(array('typedon' => $id));
           $fieldse $field[$fields];
        }
