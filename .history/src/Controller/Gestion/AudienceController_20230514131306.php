...
class AudienceController extends AbstractController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory,Menu $menu,ModuleGroupePermitionRepository $per, AudienceRepository $audience): Response
    {
    ...
    //    dd($audiences);
        ...
        if ($hasActions) {
            $table->add('id',
                TextColumn::class,
                [
                    'label' => 'Actions', 'orderable' => false, 'globalSearchable' => false, 'className' => 'grid_row_actions', 'render' => function ($value, a $context) use ($renders) {
                        $options = [
