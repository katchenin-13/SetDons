...
use Doctrine\Persistence\ObjectManager;
 ...
 class StatsService {
    ...
    {
        return $this->manager->createQuery('SELECT f FROM App\Entity\Fieldon f, App\Entity\Typedon t 
        WHERE t.id = f.typedon
        GROUP BY t.id ')
        ->getResult();
    }
    ...
    public function getAudienceCount()
    {
        return $this->manager->createQuery('SELECT COUNT(a) FROM App\Entity\Audience a WHERE a.statusaudience=')->getSingleScalarResult();
    }
    ...
    {
        return $this->manager->createQuery('SELECT COUNt(d) FROM App\Entity\Don d  ')
