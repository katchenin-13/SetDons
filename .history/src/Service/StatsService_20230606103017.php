...
use function PHPUnit\Framework\classHasAttribute;
 ...
 class StatsService {
    ...
    public function __construct(EntityManagerInterface $manager,EntityRepository $repo)
    {
    ...
    {
        return $this->repo->getRepository(Audience::class)->find();
    }
    ...
    public function getAudienceAnnee($id)
    {
