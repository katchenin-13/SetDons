...
use function PHPUnit\Framework\classHasAttribute;
 ...
 class StatsService {
    ...
    public function getStat( ){
        ...
        $audienceyes = $this->getAudiencerealieyes();
        $audienceno =$this->getAudiencerealieno();
        $audiencemois =$this->getAudienceMois();
        $audienceannee = $this->getAudienceAnnee();
        $audiencesmoiscom = $this->getAudienceMoisCom(ID);
        $audiencesanncom = $this ->getAudienceAnCom();
        $audiencesmoisloca = $this->getAudienceMoisLocalie();
        $audienceanneloca =$this->getAudienceAnlocalie();
        $$audiencemoiscateg =$this->getAudienceMoisCetagorie();
        $audienceMoisloca =
    ...
    /**
     * cette fonction permet de recuperer les audiences par mois et  communaute 
     *
     * @param [int] $id
     * @return void
     */
    ...
    public function getAudienceAnlocalie($id)
    {
        ...
        $repo = $this->manager->getRepository(Audience::class)->createQueryBuilder('a');
        return $repo->select('count(a.id)', "DATE_FORMAT(a.CreatedAt,'%Y') as annee","l.libelle")
        ->innerJoin('a.communaute', 'c')
