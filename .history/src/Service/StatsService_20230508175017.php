...
use Doctrine\Persistence\ObjectManager;
 ...
 class StatsService {
    ...
    return $this->manager->createQuery("SELECT COUNt(d),SUBSTRING(a.CreatedAt, 1, 10)  FROM App\Entity\Don AS d,App\Entity\Beneficiaire AS b,App\Entity\Communaute AS c
              WHERE d.id = b.don
