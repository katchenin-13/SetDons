...
class MissionType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('ordremission', TextType::class, $this->getConfiguration("Titre de la mission", "itre de la mission"))
            ->add('chefmission', TextType::class, $this->getConfiguration("Titre de la mission", "itre de la mission") [
                'label' => '',
