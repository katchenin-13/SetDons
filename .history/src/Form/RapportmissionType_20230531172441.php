    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('mission',EntityType::class, [
                ...
                'attr' => ['class' => 'has-select2 choixMagasin changer'],
            ...
            ->add('dateretour', DateType::class, [
                ...
                "by_reference" => true,
                "empty_data" => '',
                'attr' => ['class' => 'date dateretour choixMagasin'],
            ])
            ->add('justification', TextareaType::class, [
                'label' => 'Justification votre retard',
                'attr' => ['placeholder' => 'Saisir le text', 'class' => 'justification']
            ])
