...
use ContainerCacKBm3\getModuleService;
...
class RapportmissionType extends AbstractType
{
   ...
   public function __construct(private MissionRepository $repo)
   {
    $this->repo = $repo;
   }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options,getMission $mission): void
    {
